...
export function getConnectorStatusItems(station: QualichargeEVSEConsolidated): ConnectorStatusItem[] {
  ...
  return [
    {
      label: "Type 2",
      active: station.has_prise_type_2,
      status: undefined,
    ...
    {
      label: "Combo CCS",
      active: station.has_prise_type_combo_ccs,
      status: undefined,
    ...
    {
      label: "CHAdeMO",
      active: station.has_prise_type_chademo,
      status: undefined,
    ...
    {
      label: "Prise EF",
      active: station.has_prise_type_ef,
      status: undefined,
    ...
    {
      label: "Autre prise",
      active: station.has_prise_type_autre,
      status: null,
